...
export enum ProductActionTypes {
  ...
  removePreSelectProduct = '[Contract Product] Remove PreSelect Product'
}
export const removePreSelectProduct = createAction(
  ProductActionTypes.removePreSelectProduct,
