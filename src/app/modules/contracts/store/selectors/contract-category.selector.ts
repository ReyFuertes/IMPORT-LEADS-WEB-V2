...
export const getContractCategoryErrorMsgSelector = createSelector(
  selectContractModuleState,
  state => state?.contractCategory?.deleteCategoryErrorMsg
);
...
export const getContractCategorySelector = createSelector(
  selectContractModuleState,
  state => state ? Object.values(state?.contractCategory?.entities)
