...
import { associateCategoryTemplateToContractAction, loadUserSettingContractByCategoryIdAction } from '../../store/actions/user-setting.action';
import { getContractAsOptionSelector } from '../../store/selectors/user-setting.selector';
...
export class UserCategoryTemplateComponent extends GenericDestroyPageComponent implements OnInit, AfterViewInit {
